...
public class StringUtil {
     ...
     * 随机生成6位数(字母加数字)
     */
    public static String random6Text() {
        return randomText(6);
    }
    ...
    public static boolean isBlank(Long l) {
        return l == null ? true : l.equals(0L);
    }
    ...
    /*把字符串转换为标准json字符串
     * redis获取的字符串有些用jdk序列化，不符合json格式，用此方法转换
     * */
    public static String str2JsonStr(String str) {
        if (StringUtil.isBlank(str)) {
            return null;
        }
        str = StringEscapeUtils.unescapeJava(str);//多层json可能存在转义字符
     ...
     * @return
     */
    public static Boolean isEqual(ObjectNode o1, ObjectNode o2) {
        if (o1 == null) {
            return o2 == null;
        }
        if (o2 == null) {
...
//        System.out.println(upFirst(a));
        System.out.println(str2JsonStr("{\"a\": \"常用基本信息34\"}"));
