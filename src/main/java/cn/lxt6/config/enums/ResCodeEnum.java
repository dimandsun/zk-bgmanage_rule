...
public enum ResCodeEnum implements IEnum<Integer> {
    ...
    , AlipaySigned(10001, ResCodeLevelEnum.Process, "支付宝信息")//不同业务含义不一样，AlipayIsvTradePay时表示调起免密失败
    ...
    , PaySuccess(4115, ResCodeLevelEnum.Normal, "订单支付成功")//PayType 1 代扣，2 钱包，3 单笔
    , ReserveStatus(4133, ResCodeLevelEnum.Process,"预约结果")
